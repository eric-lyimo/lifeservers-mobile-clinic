...
;(function (win, doc, undef) {
	...
	*/
	...
	RM.init = function (options) {
		...
		var target = doc.querySelectorAll(defaults.target), // Get the node list of target elements specified by the user.
			targetLen = defaults.target.length,                     // Length of the targets node list.
